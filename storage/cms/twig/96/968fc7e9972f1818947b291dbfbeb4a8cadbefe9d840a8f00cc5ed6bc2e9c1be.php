...
/* C:\xampp\htdocs\IVYLABS\ebilty-web/themes/spotlayer/partials/summarywidget.htm */
class __TwigTemplate_4d3ce7d0e810561792bfb7a974785e70325a5090903e34b0ac5c3ebb570ff014 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"kt-widget4__item\">
    ...
    <a href=\"javascript:;\" class=\"kt-widget4__title kt-font-success\">
        ";
        // line 90
        echo call_user_func_array($this->env->getFilter('__')->getCallable(), ["Delivered Paid"]);
        echo "
    </a>
    <span class=\"kt-widget4__number kt-font-success\">";
        // line 92
        echo twig_escape_filter($this->env, ($context["paidDelivered"] ?? null), "html", null, true);
        echo "</span>
</div>
...
<div class=\"kt-widget4__item\">
    ...
    <a href=\"javascript:;\" class=\"kt-widget4__title kt-font-success\">
        ";
        // line 106
        echo call_user_func_array($this->env->getFilter('__')->getCallable(), ["Delivered Unpaid"]);
        echo "
    </a>
    <span class=\"kt-widget4__number kt-font-success\">";
        // line 108
        echo twig_escape_filter($this->env, ($context["unpaidDelivered"] ?? null), "html", null, true);
        echo "</span>
</div>
";
        // line 110
        if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 110) == 1)) {
            // line 111
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\IVYLABS\\ebilty-web/themes/spotlayer/partials/summarywidget.htm";
    }
    ...
    {
        return array (  210 => 124,  205 => 122,  192 => 111,  190 => 110,  185 => 108,  180 => 106,  163 => 92,  158 => 90,  141 => 76,  136 => 74,  120 => 61,  115 => 59,  99 => 46,  94 => 44,  78 => 31,  73 => 29,  55 => 14,  50 => 12,  37 => 1,);
    }
...
<div class=\"kt-widget4__item\">
    ...
    <span class=\"kt-widget4__number kt-font-success\">{{paidDelivered}}</span>
</div>
...
<div class=\"kt-widget4__item\">
    ...
    <span class=\"kt-widget4__number kt-font-success\">{{unpaidDelivered}}</span>
</div>
{% if user.role_id == 1 %}
...
{% endif %}", "C:\\xampp\\htdocs\\IVYLABS\\ebilty-web/themes/spotlayer/partials/summarywidget.htm", "");
    }
}
