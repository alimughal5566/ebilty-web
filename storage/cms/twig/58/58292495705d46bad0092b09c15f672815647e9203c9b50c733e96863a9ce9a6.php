...
/* C:\xampp\htdocs\ebilty-web/themes/spotlayer/partials/listingwidget.htm */
class __TwigTemplate_389099861f37f3926f6aed200298f11db6caa39539cfe285e00cabc485938f93 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
    function listing(){
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "tracking", [], "any", false, false, false, 69), "numbers_order", [], "any", false, false, false, 69), "html", null, true);
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 171) != 12)) {
            ...
            echo "\"><i class=\"la la-eye\"></i></a>';
                        ...
                        ";
            // line 180
            if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 180) != 5)) {
                // line 181
            ...
            // line 185
            echo "                        ";
            if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 185) != 5)) {
                // line 186
            ...
            // line 195
            echo "                        ";
            if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 195) != 5)) {
                // line 196
            ...
            if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 211) == 5)) {
                // line 212
                echo "                        if(data.assigned_id   ==  '-'){
                            output += '<a href=\"";
                // line 213
                echo url("bid/list");
                echo "\" class=\"btn btn-brand btn-sm btn-icon\" data-skin=\"dark\" data-toggle=\"kt-tooltip\" data-placement=\"top\" title=\"";
                echo call_user_func_array($this->env->getFilter('__')->getCallable(), ["View Bid List"]);
                echo "\"><i class=\"la la-area-chart\"></i></a>';

                        }
                        if((data.requested   ==  0 || data.requested == 100) && data.sender_id == ";
                // line 216
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", false, false, false, 216), "html", null, true);
                echo "){
                            output += '<a href=\"";
                // line 217
                echo url("dashboard/shipments");
            ...
            // line 229
            echo "                        ";
            if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasUserPermission", [0 => "order", 1 => "u"], "method", false, false, false, 229)) {
                // line 230
            ...
            echo "                        //0 = Pending | 1 = Approved | 2 = Refused | 3 = Delivered to driver | 4 = Delivered | 5 = Return request | 6 = Delivery of discards to the driver | 7 = Supply in stock | 8 = Returned | 9 = received
                        ...
                        ";
            // line 236
            if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasUserPermission", [0 => "order", 1 => "u"], "method", false, false, false, 236)) {
                // line 237
            ...
            // line 241
            echo "                        ";
            if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasUserPermission", [0 => "order", 1 => "d"], "method", false, false, false, 241) && (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 241) != 5))) {
                // line 242
            ...
            // line 246
            echo "                        ";
            if ((twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "role_id", [], "any", false, false, false, 246) == 5)) {
                // line 247
                echo "                        if((data.requested   ==  0 || data.requested == 100) && (data.sender_id != ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "id", [], "any", false, false, false, 247), "html", null, true);
                echo ")){
                            output += '<a href=\"javascript:void(0);\" class=\"btn btn-danger btn-sm delete_record kt-font-light btn-icon\" rel=\"'+data.id+'\" data-skin=\"dark\" data-toggle=\"kt-tooltip\" data-placement=\"top\" title=\"";
                // line 248
                echo call_user_func_array($this->env->getFilter('__')->getCallable(), ["Delete Shipment"]);
            ...
            // line 254
            echo "                        var output = '' +
                            '<button  style=\"border-radius: 14px\" type=\"button\" data-user-id=\"'+data.user_id+'\" data-id=\"'+data.id+'\" onclick=\"openBid(this)\" class=\" w-40 btn btn-brand btn-sm btn-icon bid\" data-toggle=\"kt-tooltip\" data-placement=\"top\" title=\"";
            // line 255
            echo call_user_func_array($this->env->getFilter('__')->getCallable(), ["Place Bid"]);
            echo "\">bid<span></span></button>';
                        ";
        }
        // line 257
        echo "                        '</div>';
...
<!--                </div>-->
    ...
    {
        return "C:\\xampp\\htdocs\\ebilty-web/themes/spotlayer/partials/listingwidget.htm";
    }
    ...
    {
        return array (  687 => 366,  681 => 363,  677 => 362,  664 => 352,  658 => 349,  654 => 348,  642 => 339,  635 => 335,  629 => 332,  552 => 257,  547 => 255,  544 => 254,  540 => 252,  533 => 248,  528 => 247,  525 => 246,  519 => 243,  516 => 242,  513 => 241,  505 => 238,  502 => 237,  500 => 236,  496 => 234,  488 => 231,  485 => 230,  482 => 229,  474 => 226,  471 => 225,  469 => 224,  462 => 222,  459 => 221,  450 => 217,  446 => 216,  438 => 213,  435 => 212,  432 => 211,  424 => 208,  421 => 207,  419 => 206,  416 => 205,  410 => 202,  407 => 201,  404 => 200,  398 => 197,  395 => 196,  392 => 195,  386 => 192,  383 => 191,  380 => 190,  374 => 187,  371 => 186,  368 => 185,  362 => 182,  359 => 181,  357 => 180,  346 => 174,  342 => 172,  340 => 171,  333 => 167,  320 => 157,  314 => 154,  307 => 150,  296 => 142,  288 => 137,  277 => 129,  268 => 123,  254 => 112,  248 => 109,  239 => 103,  226 => 100,  218 => 95,  212 => 92,  203 => 86,  190 => 83,  179 => 75,  168 => 70,  163 => 69,  156 => 65,  140 => 52,  136 => 51,  131 => 49,  89 => 24,  83 => 21,  79 => 20,  75 => 19,  71 => 18,  67 => 17,  63 => 16,  59 => 15,  50 => 9,  46 => 8,  37 => 1,);
    }
            ...
            columns: [
                {
                    ...
                    width: 140,
                    template: function(row) {
                        return '<a >{{settings.tracking.prefix_order}}{{settings.tracking.numbers_order}}'+row.shipping_number+'</a>';
                ...
                },
                {
                    ...
                    template: function (data) {
                        ...
                        var output = '' +
                            '<div id=\"shipmentbtns\" class=\"btn-group btn-group\" role=\"group\" aria-label=\"...\">'+
                            '<a href=\"{{url(\"dashboard/shipments\")}}/'+data.id+'/view\" class=\"btn btn-brand btn-sm btn-icon\" data-skin=\"dark\" data-toggle=\"kt-tooltip\" data-placement=\"top\" title=\"{{\"View Shipment\"|__}}\"><i class=\"la la-eye\"></i></a>';
                        ...
                        {% if user.role_id == 5 %}
                        if(data.assigned_id   ==  '-'){
                            output += '<a href=\"{{url(\"bid/list\")}}\" class=\"btn btn-brand btn-sm btn-icon\" data-skin=\"dark\" data-toggle=\"kt-tooltip\" data-placement=\"top\" title=\"{{\"View Bid List\"|__}}\"><i class=\"la la-area-chart\"></i></a>';
                        ...
                        {% else %}
                        var output = '' +
                            '<button  style=\"border-radius: 14px\" type=\"button\" data-user-id=\"'+data.user_id+'\" data-id=\"'+data.id+'\" onclick=\"openBid(this)\" class=\" w-40 btn btn-brand btn-sm btn-icon bid\" data-toggle=\"kt-tooltip\" data-placement=\"top\" title=\"{{\"Place Bid\"|__}}\">bid<span></span></button>';
                        {% endif %}
                        '</div>';
...
</div>", "C:\\xampp\\htdocs\\ebilty-web/themes/spotlayer/partials/listingwidget.htm", "");
    }
}
