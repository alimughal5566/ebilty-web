...
<!--        \t\t\t\t\t\t</div>-->
        ...
        echo "</button>
                      ...
                      ";
        // line 216
        if (twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "demo_mode", [], "any", false, false, false, 216)) {
            // line 217
            echo "                      <!--begin::Divider-->
 ...
 ";
    ...
    \t                    btn.removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);
        ...
        if ((($context["loginAttribute"] ?? null) == "username")) {
            // line 500
            echo "
                        data: {name: \$('#registerName').val(), email: \$('#registerEmail').val(), username: \$('#registerUsername').val(), password: \$('#registerPassword').val(), password_confirmation: \$('#rpassword').val(), phone: \$('#mobile').val(), postal_code: \$('#postal_code').val(), cnic: \$('#cnic_image').val(), bussiness_type: \$('#bussiness_type').val(),user_role_id:\$('#user_role_id').val()},

                    ";
        } else {
            // line 504
            echo "
                        data: {name: \$('#registerName').val(), email: \$('#registerEmail').val(), password: \$('#registerPassword').val(), phone: \$('#mobile').val(), postal_code: \$('#postal_code').val(), cnic: \$('#cnic_image').val(), bussiness_type: \$('#bussiness_type').val(), user_role_id:\$('#user_role_id').val()},
...
\t                           btn.removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);
     ...
     KTUtil.ready(function () {
         ...
         ";
        // line 599
        if (twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "demo_mode", [], "any", false, false, false, 599)) {
            // line 600
 ...
 ";
    ...
    {
        return array (  916 => 338,  890 => 621,  867 => 600,  865 => 599,  835 => 572,  789 => 528,  784 => 526,  779 => 525,  773 => 523,  771 => 522,  755 => 508,  749 => 504,  743 => 500,  741 => 499,  697 => 458,  693 => 457,  663 => 430,  657 => 427,  567 => 339,  564 => 338,  562 => 315,  539 => 316,  537 => 315,  529 => 310,  525 => 309,  508 => 295,  495 => 284,  479 => 271,  475 => 270,  463 => 261,  459 => 260,  447 => 251,  443 => 250,  431 => 241,  427 => 240,  405 => 221,  399 => 217,  397 => 216,  386 => 208,  382 => 207,  375 => 203,  368 => 201,  361 => 197,  357 => 196,  352 => 193,  348 => 191,  341 => 187,  335 => 184,  331 => 183,  319 => 176,  311 => 171,  304 => 167,  287 => 153,  279 => 148,  267 => 139,  259 => 134,  253 => 130,  247 => 128,  242 => 126,  236 => 123,  228 => 118,  220 => 113,  213 => 108,  211 => 107,  175 => 76,  169 => 73,  162 => 69,  156 => 66,  150 => 63,  144 => 60,  140 => 59,  137 => 58,  129 => 53,  125 => 51,  123 => 50,  116 => 46,  108 => 41,  104 => 39,  97 => 36,  93 => 35,  84 => 34,  81 => 33,  57 => 16,  51 => 13,  37 => 1,);
    }
