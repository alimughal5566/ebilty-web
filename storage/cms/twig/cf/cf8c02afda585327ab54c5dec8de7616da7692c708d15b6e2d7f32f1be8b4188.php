...
/* C:\xampp\htdocs\IVYLABS\ebilty-web/themes/spotlayer/layouts/front.htm */
class __TwigTemplate_2b0cd8d750da5f71f5d21641ab5b08c0eccf22e4d74ac4536ed1ae7aaa59d3d2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t<script type=\"text/javascript\" src=\"//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js\"></script>
    ...
    {
        return "C:\\xampp\\htdocs\\IVYLABS\\ebilty-web/themes/spotlayer/layouts/front.htm";
    }
...
\t\t\t\t\t\t\t\t\t<!-- Login trigger -->
\t\t\t\t\t\t\t\t\t<div class=\"topnav login--panel topnav-account-login topnav-login align-self-center\">
\t\t\t\t\t\t\t\t\t\t<a class=\"topnav-item \" href=\"{{url('/login/')}}\">
\t\t\t\t\t\t\t\t\t\t\t<i class=\"login-icon fas fa-sign-in-alt visible-xs xs-icon\"></i>
\t\t\t\t\t\t\t\t\t\t\t<span class=\"topnav-item--text\">{{'LOGIN'|__}}</span>
\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t</div>
...
</html>", "C:\\xampp\\htdocs\\IVYLABS\\ebilty-web/themes/spotlayer/layouts/front.htm", "");
    }
}
