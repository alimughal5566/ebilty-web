...
/* F:\xampp\htdocs\ebilty-web/themes/spotlayer/pages/home.htm */
class __TwigTemplate_a77a1f8b5ab1346cd69d196f2d296e00faed1d5919f5bfda166d5e16d634f16e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"custom-slider kl-slideshow iosslider-slideshow uh_light_gray maskcontainer--shadow_ud iosslider--custom-height scrollme\">
\t<!-- Loader -->
\t<div class=\"kl-loader\">
...
\t\t\t\t\t\t\t<a href=\"";
            // line 57
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["slider"], "link", [], "any", false, false, false, 57), "html", null, true);
            echo "\" target=\"_self\" class=\"more\">  <!-- ";
            echo $this->extensions['Cms\Twig\Extension']->pageFilter("about");
            echo " -->
\t\t\t\t\t\t\t\t";
            // line 58
            echo call_user_func_array($this->env->getFilter('__')->getCallable(), ["TRANSPORTER"]);
            echo "
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t<a href=\"";
            // line 60
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["slider"], "link", [], "any", false, false, false, 60), "html", null, true);
            echo "\" target=\"_self\" class=\"more\">  <!-- ";
            echo $this->extensions['Cms\Twig\Extension']->pageFilter("about");
            echo " -->
\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t";
        // line 147
        echo call_user_func_array($this->env->getFilter('__')->getCallable(), [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "company", [], "any", false, false, false, 147), "title", [], "any", false, false, false, 147)]);
        echo "
\t\t\t\t\t</h3>
\t\t\t\t\t<!--/ Title -->
\t\t\t\t</div>
...
\t\t\t\t\t";
        // line 164
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "website", [], "any", false, false, false, 164), "services", [], "any", false, false, false, 164));
...
\t\t\t\t\t\t\t\t\t<img src=\"";
            // line 171
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (($__internal_1cfccaec8dd2e8578ccb026fbe7f2e7e29ac2ed5deb976639c5fc99a6ea8583b = twig_get_attribute($this->env, $this->source, ($context["settings"] ?? null), "services_pics", [], "any", false, false, false, 171)) && is_array($__internal_1cfccaec8dd2e8578ccb026fbe7f2e7e29ac2ed5deb976639c5fc99a6ea8583b) || $__internal_1cfccaec8dd2e8578ccb026fbe7f2e7e29ac2ed5deb976639c5fc99a6ea8583b instanceof ArrayAccess ? ($__internal_1cfccaec8dd2e8578ccb026fbe7f2e7e29ac2ed5deb976639c5fc99a6ea8583b[$context["key"]] ?? null) : null), "path", [], "any", false, false, false, 171), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t";
            // line 180
            echo call_user_func_array($this->env->getFilter('__')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["service"], "title", [], "any", false, false, false, 180)]);
            echo "
\t\t\t\t\t\t\t\t\t\t</h3>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<!--/ Title -->
...
\t\t\t\t\t\t\t\t\t\t\t";
            // line 188
            echo call_user_func_array($this->env->getFilter('__')->getCallable(), [twig_get_attribute($this->env, $this->source, $context["service"], "description", [], "any", false, false, false, 188)]);
            echo "
\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<!--/ Description -->
...
<!--/ Title with Call to Action Button section with custom paddings -->
 ...
 ";
    ...
    {
        return "F:\\xampp\\htdocs\\ebilty-web/themes/spotlayer/pages/home.htm";
    }
    ...
    {
        return array (  404 => 258,  394 => 259,  391 => 258,  389 => 253,  384 => 254,  382 => 253,  366 => 240,  362 => 239,  351 => 231,  342 => 225,  316 => 201,  297 => 188,  286 => 180,  274 => 171,  266 => 165,  262 => 164,  242 => 147,  234 => 142,  187 => 98,  170 => 84,  157 => 73,  139 => 61,  133 => 60,  128 => 58,  122 => 57,  113 => 51,  107 => 50,  97 => 43,  90 => 41,  72 => 26,  68 => 25,  63 => 22,  59 => 21,  37 => 1,);
    }
...
<!--/ Title with Call to Action Button section with custom paddings -->
 ...
 {% endput %}", "F:\\xampp\\htdocs\\ebilty-web/themes/spotlayer/pages/home.htm", "");
    }
}
