<?php 
class Cms60ae5d1b5c7cf868113186_eb977364b75c803d19367103ae0e0a54Class extends Cms\Classes\PageCode
{
...
public function onStart(){
    ...
    $this['item']           =    $item =   \RainLab\User\Models\User::find(Auth::getUser()->id);
   ...
   //Storage::delete('/uploads/public/5f6/737/521/5f6737521a941235543983.png');
  // Storage::delete($item->files[0]->file_name);
   //dd($item->files[0]->delete());  
 // dd(Storage::delete('/uploads/public/5f6/737/521/5f6737521a941235543983.png'));
...
public function onSave()
{
    ...
    $item->company            = (($data['company'] != '') ? htmlspecialchars($data['company']) : null);
    ...
    if (Input::hasFile('files')) {
        ...
        $item->files()->create(['data' => Input::file('files')]);
        ...
        if(isset($data['addresses'])){
            foreach($data['addresses'] as $address){
                if(isset($address['id'])){
                    ...
                    $subitem->name              = htmlspecialchars($address['street_address']);
