<?php 
use Illuminate\Support\Facades\Storage;use Illuminate\Http\Request;use \Responsiv\Currency\Models\Currency;use \Spot\Shipment\Models\Settings;use \Tiipiik\SmsSender\Models\Setting as SMS;class Cms6093b395d7355197057560_eaaf664704e92fffd79385740c7b3ac0Class extends Cms\Classes\PageCode
{
...
elseif($this->param('page') == 'cars'){
    ...
    $this->page->listing        = true;
    $this->page->actions   = array(
    'add'   =>  url('dashboard/settings/vehicle/create'));
...
public function onDelete()
{
    ...
    switch($data['type']){
        ...
        case 'vehicle':
            ...
            if(null !== post('id')){
            if(is_array(post('id'))){
            \Spot\Shipment\Models\Vehicles::whereIn('id',post('id'))->delete();
            }else{
            \Spot\Shipment\Models\Vehicles::find($data['id'])->delete();
            }
            return Redirect::back();
            }
        case 'destination':
