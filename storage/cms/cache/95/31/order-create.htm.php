<?php 
use \Spot\Shipment\Models\Settings;class Cms60b09ac5ae9f2087679421_89b73150d1bfcd806f0e987546d9ad27Class extends Cms\Classes\PageCode
{
...
public function onSave()
{
    ...
    if ($addShipmentForm == "add_form_normal")
    {
        ...
        $item  = new \Spot\Shipment\Models\Order;
            ...
            if(isset($data['budget_client'])){
                $item->budget_client = $data['budget_client'];
            }
            $item->save();
    ...
    elseif ( $addShipmentForm == "add_form_simple")
    {
        ...
        $item->type                  =2;
        $item->status_id             =19;
        $item->ship_time     = $data['ship_time'];
        $item->is_insured     = $data['is_insured'];
        $item->created_by     = Auth::getUser()->id;
        if(isset($data['assigned_id']) && $data['assigned_id'] != ''){
            $item->assigned_id  = htmlspecialchars($data['assigned_id']);}
        $item->save();
