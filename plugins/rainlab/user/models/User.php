...
//        'username' => 'required|between:2,255|unique:users',
        'password' => 'required:create|between:5,10',
    ...
    public $hasMany = [
        'contacts' => ['\Spot\Shipment\Models\Contact'],
       // 'location' => ['\Spot\Shipment\Models\Address'],
    ];
    ...
    public $attachOne = [
        ...
        //'commercial' => \System\Models\File::class,
        //'tax' => \System\Models\File::class
    ]; 
